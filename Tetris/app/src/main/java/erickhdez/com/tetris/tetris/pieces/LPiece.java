...
public class LPiece extends TetrisPiece {
    public LPiece(int resourceImage) {
        ...
        positions = new Cell[][] {
                {new Cell(0, 4), new Cell(1, 4), new Cell(2, 4), new Cell(2, 5)},
                {new Cell(1, 4), new Cell(1, 5), new Cell(1, 6), new Cell(0, 6)},
                {new Cell(0, 4), new Cell(0, 5), new Cell(1, 5), new Cell(2, 5)},
                {new Cell(0, 4), new Cell(0, 5), new Cell(0, 6), new Cell(1, 4)}
        };
    }
}
